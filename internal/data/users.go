...
func (m UserModel) Insert(user *User) error {
	...
	// to perform the insert here will be a violation of the UNIQUE "users_email_key"
	// constraint that we set up in the previous chapter. We check for this error
	// specifically and return the custom ErrDuplicateEmail error instead.
...
// when updating the movie. And we also check for a violation of the "users_email_key"
